package com.example.absensikaryawan.adapter;
...
import com.example.absensikaryawan.kelas.Pegawai;
...
public class DaftarAdapter extends RecyclerView.Adapter<DaftarAdapter.MyViewHolder> {
    ...
    public static class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public TextView id, nama, nidn, tanggal, status, jam;
        ...
        public MyViewHolder(View view) {
            ...
            jam = view.findViewById(R.id.tv_jam_item_daftar);
        }
    }
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        ...
        holder.jam.setText(pegawai.getJam());
    }
