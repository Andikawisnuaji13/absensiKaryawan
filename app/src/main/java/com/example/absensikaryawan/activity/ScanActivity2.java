...
import com.example.absensikaryawan.api.Apiservice;
import com.example.absensikaryawan.api.Apiurl;
import com.example.absensikaryawan.kelas.database;
...
//        Log.v("TAG 2", rawResult.getBarcodeFormat().toString());
        ...
        if (cekSimpan) {
            ...
            Toast.makeText(ScanActivity2.this, "Absen berhasil." , Toast.LENGTH_LONG).show();
            ...
            Toast.makeText(ScanActivity2.this, "Anda sudah absen!", Toast.LENGTH_LONG).show();
            onResume();
