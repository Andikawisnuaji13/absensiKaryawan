...
public class LoginActivity extends AppCompatActivity {
    ...
    private void initCreateAccountTextView() {
        TextView textViewCreateAccount = (TextView) findViewById(R.id.buttoncreat);
    ...
    private void initViews() {
        ...
        editTextPassword = (EditText) findViewById(R.id.edpw);
        textInputLayoutEmail = (TextInputLayout) findViewById(R.id.textinputemail);
        textInputLayoutPassword = (TextInputLayout) findViewById(R.id.textinputpw);
